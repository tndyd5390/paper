...
<body>
	...
	<form class="form" action="adminNoticeUpdateProc.do" method="post" name="f" onsubmit='return doSubmit(this)'>
	<input type="hidden" name="nNo" value="<%=CmmUtil.nvl(nDTO.getNotice_no())%>">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel-body">
					<div class="form-group">
						<label>제목 <a>*</a></label> <input type="text" class="form-control Sub-Txt" name="title" id="title" value="<%=CmmUtil.nvl(nDTO.getNotice_title())%>">
						<hr>
					</div>
					<div class="form-group">
						<label class="block">접수시작일 <a>*</a></label> <input type="date"
							class="form-control subTxt Sub-Txt" name="reception_date" id="reception_date" value="<%=CmmUtil.nvl(nDTO.getReception_date())%>">
						<hr>
					</div>
					<div class="form-group">
						<label class="block">접수마감일 <a>*</a></label> <input type="date"
							class="form-control subTxt Sub-Txt" name="end_date" id="end_date" value="<%=CmmUtil.nvl(nDTO.getEnd_date())%>">
						<hr>
					</div>
					<div class="form-group">
						<label class="block">개최일 <a>*</a></label> <input type="date"
							class="form-control subTxt Sub-Txt" name="exhibition_date" id="exhibition_date" value="<%=CmmUtil.nvl(nDTO.getExhibition_date())%>">
						<hr>
					</div>
			...
			<input type="submit" class="btn btn-primary btn-right" value="수정" >
		</section>
		</section>
		</section>
	</form>
